...
img_left.setImageResource(array.images1[num_left]);
text_left.setText(array.texts1[num_left]);
...
img_right.setImageResource(array.images1[num_right]);
text_right.setText(array.texts1[num_right]);
