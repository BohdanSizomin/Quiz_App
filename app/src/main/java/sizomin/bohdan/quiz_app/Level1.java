...
img_left.setImageResource(array.images[num_left]);
text_left.setText(array.texts[num_left]);
...
img_right.setImageResource(array.images[num_right]);
text_right.setText(array.texts[num_right]);
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==10){
                        ...
                        else{SharedPreferences.Editor editor = save.edit();
